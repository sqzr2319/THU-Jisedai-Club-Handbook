...
\begin{document}
\pagecolor{mybg}
\chatbubble[left]{qingfen.jpg}{不愧是次世代！}
\chatbubble[left]{taozi.jpg}{不愧是次世代～}
\chatbubble[right]{zijing.jpg}{不愧是次世代。}
\chatbubble[left]{taozi.jpg}{嘿嘿，不知不觉和大家创造了这么多回忆呢……}
\chatbubble[left]{qingfen.jpg}{还想在未来创造更多更多！就和你一起！}
\chatbubble[right]{zijing.jpg}{我们希望与你度过更长的时光。}
\chatbubble[left]{taozi.jpg}{那么接下来，就让我们携手同行吧。}
\newpage  % 新的一页
\vspace{3em}
\begin{center}
    ...
    \textcolor{thuorange}{2024年次世代动漫社社庆晚会 Opening Song}  % 英文标题
% 左对齐
\vspace{2em}
\color{white}
\fontsize{12pt}{14pt}
