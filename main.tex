...
\graphicspath{{figures/},{figures/大部门/},{figures/小部门/},{figures/看板/},{figures/头像/},{figures/部酱/},{figures/页眉页脚/}}  % 设置图片路径为figures目录
% 颜色和页面布局设置
...
% 设置页脚
% LE: 偶数页左侧页脚
\fancyfoot[LE]{\hspace{-1.1cm}\raisebox{-27pt}{\textcolor{white}{\textbf{\textsf{\thepage}}}}} 
% RO: 奇数页右侧页脚
\fancyfoot[RO]{\rlap{\hspace{0.65cm}\raisebox{-27pt}{\textcolor{white}{\textbf{\textsf{\thepage}}}}}}
...
\newpage
\arial
\input{chapters/4_departments.tex}  
\input{chapters/5_messages.tex}
\newpage
